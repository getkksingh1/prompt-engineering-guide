...
As better introduced [here](https://promptingguide.agie.ai/techniques/rag), RAG can be defined as:
...
While RAG has also involved the optimization of pre-training methods, current approaches have largely shifted to combining the strengths of RAG and powerful fine-tuned models like [ChatGPT](https://promptingguide.agie.ai/models/chatgpt) and [Mixtral](https://promptingguide.agie.ai/models/mixtral). The chart below shows the evolution of RAG-related research:
