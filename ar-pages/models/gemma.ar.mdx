...
### Role Playing
We can also test Gemma for role-playing capabilities, which is a useful ability to not only personalize model responses but also to build more complex domain-specific [LLM agents](https://promptingguide.agie.ai/research/llm-agents).
...
### Reasoning
You can elicit Gemma's reasoning capabilities by using [zero-shot chain-of-thought prompting](https://promptingguide.agie.ai/techniques/cot#zero-shot-cot-prompting) as follows:
