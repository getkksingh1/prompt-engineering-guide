...
Gemini Ultra achieves highest accuracy when combined with approaches like [chain-of-thought (CoT) prompting](https://promptingguide.agie.ai/techniques/cot) and [self-consistency](https://promptingguide.agie.ai/techniques/consistency) which helps dealing with model uncertainty. 
