...
Gemini Ultra在与[思维链提示(chain-of-thought (CoT) prompting)](https://promptingguide.agie.ai/techniques/cot)和[自洽性(self-consistency)](https://promptingguide.agie.ai/techniques/consistency)等有助于处理模型不确定性的方法相结合时，达到了最高的准确率。
