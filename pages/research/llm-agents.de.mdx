...
<Cards>
    ...
    href="https://promptingguide.agie.ai/techniques/react"
    />
</Cards>
...
- [Funktionsaufruf](https://promptingguide.agie.ai/applications/function_calling) - erweitert LLMs mit der Fähigkeit zur Werkzeugnutzung, die die Definition eines Satzes von Tool-APIs umfasst und diese als Teil einer Anfrage dem Modell zur Verfügung stellt.
